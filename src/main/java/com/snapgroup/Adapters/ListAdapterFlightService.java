...
public class ListAdapterFlightService extends BaseAdapter
{


    private Activity context_1;
    ArrayList<String> namehotel;
    public ListAdapterFlightService(Activity context,ArrayList<String> nameFLights)
    {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        convertView = null;
        if (convertView == null) {
            convertView = LayoutInflater.from(context_1).inflate(R.layout.flight_service_info, null);
